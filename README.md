# Blunix GmbH Service Level Agreement Contract Template for Linux Managed Hosting Customers

This git repository contains the template for the Service Level Agreement issued to Linux Managed Hosting customers.
...
For this repository into the customers Gitlab or Github account and edit all occurances of `EDITME`.
...
Copyright Blunix GmbH 2026. All rights reserved.
