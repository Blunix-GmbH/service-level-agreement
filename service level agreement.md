...
Anlage-Link:		https://git.example.com/contracts/blunix-sla 	


Blunix GmbH Berlin
Linux Support, Linux Consulting, Managed Hosting und Training

Web:				https://www.blunix.com
Telefon: 			030 / 301 338 38
E-Mail: 			info@blunix.com
...
Dieses Service Level Agreement (im Folgenden „SLA“) legt die Rechte und Pflichten der Vertragsparteien im Zusammenhang mit dem Betrieb, der Wartung, der Unterstützung und der Entstörung von IT-Systemen des Auftraggebers durch den Auftragnehmer fest. Es regelt Art und Umfang der in diesem SLA beschriebenen Leistungsarten des Auftragnehmers in diesen Bereichen sowie die hierfür geltenden qualitativen und organisatorischen Anforderungen und die hierfür erforderlichen Mitwirkungs- und Beistellpflichten des Auftraggebers. Welche der in diesem SLA beschriebenen Leistungen im Einzelfall vom Auftragnehmer zu erbringen sind, ergibt sich aus diesem SLA in Verbindung mit der Anlage.

Die Anlage zu diesem SLA ist Bestandteil des SLA. Sie legt für die dort jeweils aufgeführten Systeme des Auftraggebers fest, in welchem Umfang sie von diesem SLA erfasst werden und welche in diesem SLA vorgesehenen servicebezogenen Parameter für diese Systeme jeweils gelten.

Für die in der Anlage bezeichneten Systeme, die von diesem SLA erfasst sind, gelten ausschließlich die Regelungen dieses SLA einschließlich Anlage; die Allgemeinen Geschäftsbedingungen für Beratungs-, Support- und Notfallleistungen der Blunix GmbH finden auf diese Leistungen keine Anwendung.
...
Infrastruktur bezeichnet die Gesamtheit der in der Anlage bezeichneten Systeme sowie deren Zusammenspiel, soweit dieses zum Betrieb der durch den Auftraggeber genutzten Software erforderlich ist.

Der Standardsatz bezeichnet eine Vergütung von 50,00 EUR je angefangene 30 Minuten Arbeitszeit des Auftragnehmers, soweit in diesem SLA oder der Anlage für bestimmte Leistungen keine abweichende Vergütung geregelt ist. Soweit in diesem SLA oder der Anlage nichts anderes angegeben ist, verstehen sich alle genannten Vergütungen und Entgelte zuzüglich gesetzlicher Umsatzsteuer.
...
Der Auftraggeber stellt sicher, dass der benannte technische Ansprechpartner über die fachliche und technische Kompetenz verfügt, um die in diesem Service-Level-Agreement und in der Anlage beschriebenen Anforderungen zu verstehen und die dort vorgesehenen Mitwirkungs- und Freigabepflichten zu erfüllen.

Änderungen der Anlage im Sinne von Ziffer 3.1 dürfen auf Seiten des Auftraggebers ausschließlich durch die in der Anlage benannten technischen Ansprechpartner initiiert werden, insbesondere durch das Erstellen von Pull-/Merge-Requests im hierfür vorgesehenen Git-Repository.


## 1.4 Kommunikation

Formgebundene Erklärungen im Zusammenhang mit diesem SLA (insbesondere Kündigungen, Fristsetzungen und sonstige rechtserhebliche Erklärungen) sind in Textform per E-Mail abzugeben. Erklärungen an den Auftragnehmer sind an p.thurner@blunix.com, Erklärungen an den Auftraggeber an m.mustermann@example.com zu richten. Für die Einhaltung von Fristen ist der Zeitpunkt maßgeblich, zu dem die E-Mail den Mailserver der jeweils anderen Vertragspartei erreicht.

Änderungswünsche in Bezug auf die Anlage nach Ziffer 3.1 werden durch Pull-/Merge-Requests in dem dort bezeichneten Git-Repository kommuniziert; zusätzlich sind die in der Anlage benannten technischen Ansprechpartner des Auftraggebers hierüber per E-Mail zu informieren. Ergänzend gelten die Regelungen in Ziffer 3.1.

Änderungswünsche, technische Abstimmungen, Erweiterungswünsche und sonstige fachliche Anforderungen im Zusammenhang mit den von diesem SLA und der Anlage erfassten Systemen und Leistungen werden über GitLab-Issues im Playbook-Git-Repository erfasst und nachverfolgt. Das Playbook-Git-Repository ist so zu konfigurieren, dass das Anlegen, Ändern und Updaten von Issues Benachrichtigungs-E-Mails an die für das Git-Repository hinterlegten Projektbeteiligten auslöst.

Sonstige laufende Kommunikation (insbesondere kurzfristige Nachfragen und allgemeine Abstimmungen) erfolgt über den in der Anlage bezeichneten allgemeinen Chat-Raum. Die Nutzung dieses Chat-Raums ersetzt weder formgebundene Erklärungen im Sinne dieses SLA noch die nach Ziffer 5.1.1 erforderliche Notfallmeldung.

Die in Ziffer 5.1.1 geregelte Nutzung des SLA-Monitoring-Chat-Raums als Bestandteil einer Notfallmeldung bleibt hiervon unberührt.
...
## 2.1 Technische Infrastruktur des Auftraggebers

Der Auftragnehmer stellt im Rahmen dieses SLA keine eigene Rechenzentrums-, Cloud-, Netzwerk- oder Storage-Infrastruktur bereit. Sämtliche Systeme im Sinne der Begriffsbestimmungen nach Ziffer 1.2 werden auf durch den Auftraggeber bereitgestellter Infrastruktur betrieben, die vom Auftraggeber selbst oder von von ihm beauftragten Dritten zur Verfügung gestellt wird. Dies umfasst ohne Ausnahme alle zum Betrieb der Systeme erforderlichen Ressourcen, einschließlich Rechenzentrums-, Cloud-, Netzwerk-, Storage-, DNS-, Mail- und sonstiger technischer Infrastruktur- oder Plattformdienste.
...
Der Auftraggeber stellt sicher, dass die von ihm gewählte Infrastruktur die zur Leistungserbringung nach diesem SLA erforderlichen technischen Voraussetzungen erfüllt und dem Auftragnehmer die in Ziffer 6.3 beschriebenen administrativen Zugriffsrechte eingeräumt werden.


## 2.2 Playbook-Git-Repository

Das in Ziffer 1.2 definierte Playbook-Git-Repository dient als zentrale, versionierte Arbeitsgrundlage für die Konfiguration und den Betrieb der in der Anlage bezeichneten Systeme. Es enthält insbesondere den Terraform-Konfigurationen zur Erstellung der Systeme mit deren jeweiligen Cloud- oder Hosting-Providern sowie die Ansible-Konfigurationen wie Playbooks, Rollen-Einbindungen, Inventories und Variablen, die für Aufbau, Änderung und Wiederaufbau der Infrastruktur erforderlich sind.
...
Der Auftragnehmer kann für den Auftraggeber kundenspezifische Ansible-Rollen entwickeln, zum Beispiel zur Abbildung spezieller Anwendungen oder Infrastrukturkomponenten des Auftraggebers. In diesem Fall entscheidet der Auftraggeber, ob diese kundenspezifischen Rollen ausschließlich für ihn und seine Systeme genutzt werden oder ob der Auftragnehmer sie in seine allgemein verfügbaren Rollen (insbesondere die unter „Blunix-GmbH“ auf GitHub bereitgestellten Rollen) aufnehmen darf.
...
- cus-util-prod-monitoring-1: Monitoring-Server für technisches Monitoring
- cus-util-prod-monitoring-2: Monitoring-Server für SLA-relevantes Monitoring
- cus-util-prod-backup-1: primärer Backup-Server
- cus-util-prod-backup-2: sekundärer Backup-Server mit von cus-util-prod-backup-1 abweichender Backup-Software und Betrieb bei einem anderen Hosting- oder Cloud-Provider
- cus-util-prod-git-1: GitLab-Server
- cus-util-prod-gitci-1: optionaler GitLab-Runner
- cus-util-prod-log-1: zentraler systemd-journal-Server
- cus-util-prod-gateway-1: VPN-Server
- cus-util-prod-gateway-2: sekundärer VPN-Server
- cus-util-prod-deploy-1: optionaler Deploy-Server für Anwendungs-Deployments

Welche dieser Systeme betrieben werden, ergibt sich aus der Anlage.

### 2.4.1 Monitoring-System

Der Auftragnehmer richtet auf dem in der Anlage als „cus-util-prod-monitoring-1“ bezeichneten System für die in der Anlage bezeichneten Systeme im vertraglich vereinbarten Umfang zwei Monitoring-Tools ein:

- ein technisches Monitoring auf dem in der Anlage als „cus-util-prod-monitoring-1“ bezeichneten System zur Überwachung interner technischer Kennzahlen und Systemzustände (z.B. CPU-Last, Arbeitsspeicher- und Plattenauslastung, Ausführung von Cronjobs) und
- ein SLA-Monitoring auf dem in der Anlage als „cus-util-prod-monitoring-2“ bezeichneten System zur Überwachung der in der Anlage benannten Monitoring-Messgegenstände für Systeme, die in der Anlage als Produktiv-Systeme im Sinne von Ziffer 5.1 geführt werden und die der Auftraggeber gemäß Anlage überwachen lässt (einschließlich, aber nicht beschränkt auf die Monitoring-Messgegenstände, die für Verfügbarkeitsziele nach Ziffer 5.2 maßgeblich sind); dieses System wird bei einem von cus-util-prod-monitoring-1 abweichenden Hosting- oder Cloud-Provider betrieben; eine Übereinstimmung mit dem für cus-util-prod-backup-2 genutzten Hosting- oder Cloud-Provider ist zulässig.

Die Messwerte des technischen Monitorings bilden keinen Nachweis über die Einhaltung oder Nichterfüllung von Service Levels, insbesondere nicht von Verfügbarkeitszielen im Sinne von Ziffer 5.2. Für die Berechnung und den Nachweis von Service Levels, insbesondere von Verfügbarkeitszielen, sind ausschließlich die Messwerte des SLA-Monitorings auf dem System „cus-util-prod-monitoring-2“ maßgeblich.

Alarmierungen aus dem technischen Monitoring erfolgen an den in der Anlage benannten technischen Monitoring-Chat-Raum, Alarmierungen aus dem SLA-Monitoring an den in der Anlage benannten SLA-Monitoring-Chat-Raum. Soweit für bestimmte Systeme in der Anlage Verfügbarkeitsziele oder sonstige Uptime-Garantien im Sinne von Ziffer 5.2 vereinbart sind, werden Messobjekte, Prüfmethode, Erfolgskriterien, Messintervall und Toleranzen in der Anlage festgelegt; im Übrigen setzt der Auftragnehmer das technische Monitoring nach fachlichem Ermessen auf.

Die Monitoring-Systeme und deren Alarmierungen werden nach bestem fachlichen Ermessen eingerichtet, gewartet und betrieben; technische Störungen in Netzen oder bei Drittanbietern (insbesondere Chat-, E-Mail- oder Cloud-/Rechenzentrums-Providern) können gleichwohl im Einzelfall zu verzögerten oder ausbleibenden Alarmierungen führen. Weitergehende Ansprüche ergeben sich hieraus nur im Rahmen der Ziffer 8.

Der Auftragnehmer wird eingehende kritische Alarmierungen nach Möglichkeit zeitnah prüfen und nach fachlichem Ermessen darauf reagieren; hierdurch werden jedoch weder eine Notfallmeldung im Sinne von Ziffer 5.1.1 ersetzt noch vertragliche Pflichten zur Einhaltung bestimmter Reaktionszeiten begründet.

Monitoring-Alarmierungen ersetzen nicht die Notfall-Meldung durch den Auftraggeber; Notfälle sind ausschließlich nach Maßgabe des Meldewegs gemäß Ziffer 5.1.1 zu melden. Verweise auf die Monitoring-Dashboards werden in der Anlage aufgeführt.

Für Systeme, für die in der Anlage Verfügbarkeitsziele im Sinne von Ziffer 5.2 festgelegt sind, werden die dort beschriebenen Monitoring-Messgegenstände, Erfolgskriterien, Messintervalle, Toleranzschwellen und Monitoring-Dashboards in der Anlage abgebildet und anschließend in das Playbook-Git-Repository überführt und auf das SLA Monitoring-Tool angewendet. Für alle übrigen Systeme erfolgt die Festlegung und Anpassung der Monitoring-Messgegenstände, Erfolgskriterien, Messintervalle und Toleranzschwellen unmittelbar im Playbook-Git-Repository. Änderungen an diesen Parametern erfolgen mittels Pull-/Merge-Requests; sie gelten als abgestimmt, wenn sie von einem in der Anlage als technisch verantwortlich benannten Ansprechpartner des Auftraggebers freigegeben wurden.

### 2.4.2 Backup-Systeme

Der Auftragnehmer richtet auf den in der Anlage als „cus-util-prod-backup-1“ und „cus-util-prod-backup-2“ bezeichneten Utility-Systemen für alle weiteren in der Anlage bezeichneten Systeme zwei voneinander unabhängige, technisch unterschiedliche Sicherungslösungen (Backup-Programme) ein, die die Sicherungen automatisiert durchführen; die beiden Sicherungslösungen werden auf zwei verschiedenen Hosting- bzw. Cloud-Providern betrieben. Daten, die nicht direkt aus dem Dateisystem gesichert werden können und daher vorab per Skript zu erzeugen sind (z. B. Datenbank‑Dumps), werden von beiden Backup‑Programmen jeweils unmittelbar vor dem Sicherungslauf einmal erstellt.

Standard-Sicherungsrhythmus ist, sofern in der Anlage nicht abweichend geregelt: tägliche Sicherung einmal zwischen 00:00 Uhr und 07:00 Uhr; Aufbewahrung: sieben tägliche Stände, anschließend für vier Wochen drei Sicherungsstände pro Woche, anschließend für zwölf Monate zwei Sicherungsstände pro Monat. Abweichungen hiervon werden in der Anlage je System festgelegt.
...
Der Auftragnehmer schuldet weder das Gelingen jeder einzelnen Sicherung noch die Wiederherstellbarkeit von Daten, die aufgrund von Umständen außerhalb seines Verantwortungsbereichs nicht oder fehlerhaft gesichert wurden (insbesondere Störungen der vom Auftraggeber eingesetzten Infrastruktur, Fehlkonfigurationen der Anwendungen des Auftraggebers oder unzureichende Speicherkapazitäten). Im Übrigen gelten die Haftungsregelungen in Ziffer 8.
...
Der Auftragnehmer betreibt auf dem in der Anlage als „cus-util-prod-log-1“ bezeichneten Utility-System ein zentrales Logging System zur zentralen Speicherung von Logdaten. Alle in der Anlage bezeichneten Systeme werden so konfiguriert, dass ihre systemd-Journal-Logs an das zentrale Logging System übertragen werden.

Der Auftraggeber kann seine Anwendungen so konfigurieren, dass diese in das systemd-Journal des jeweiligen Systems schreiben; solche Einträge werden dann ebenfalls an das zentrale Logging System übermittelt.
...
Soweit in der Anlage ein Gitlab-System „cus-util-prod-git-1“ aufgeführt ist, betreibt der Auftragnehmer darauf eine Gitlab Installation, die insbesondere das Playbook-Git-Repository nach Ziffer 2.2 und das Git-Repository der Anlage nach Ziffer 3.1 hostet. Das Gitlab System kann als Git-Hosting-PLatform für weitere vom Auftraggeber genutzte und verwaltete Git-Repositories dienen. Ansible-Rollen und weiterer Code, welche der Auftragnehmer im Auftrag durch den Auftraggeber erstellt hat, können ebenfalls auf dem Gitlab System gehostet und verwaltet werden.

Der Auftraggeber verwaltet die Inhalte und projektinternen Berechtigungen der von ihm angelegten oder verwalteten Repositories eigenverantwortlich. Der Auftragnehmer überprüft die Inhalte der vom Auftraggeber angelegten und verwalteten Repositories (zum Beispiel Repositories für Webanwendungen des Auftraggebers) nicht; eine inhaltliche Prüfung erfolgt nur, soweit sie für die Erfüllung dieses SLA erforderlich ist oder gesondert beauftragt wird. Für Fehler in Programmen, Konfigurationen oder sonstigen Inhalten, die der Auftraggeber in solchen Repositories verwaltet und die nicht vom Auftragnehmer erstellt oder geändert wurden, trägt der Auftraggeber die Verantwortung.

### 2.4.5 Gitlab-Runner-Systeme

Soweit in der Anlage Gitlab-Runner-Systeme (zum Beispiel „cus-util-prod-gitci-1“) aufgeführt sind, richtet der Auftragnehmer diese initial so ein, dass sie als Runner im Gitlab System registriert sind und für dort konfigurierte Pipelines verwendet werden können.
...
Auf den in der Anlage „cus-util-prod-gateway-1“ und „cus-util-prod-gateway-2“ bezeichneten Utility-Systemen betreibt der Auftragnehmer VPN-Gateway-Systeme, über die insbesondere die administrativen Zugriffe auf die übrigen Systeme sowie sonstige Firmen-interne Dienste (zum Beispiel Gitlab, Monitoring und SSH-Zugänge, Staging-Webhosting-Umgebungen) durch Mitarbeiter des Auftraggebers und des Auftragnehmers erfolgen. Systeme und Dienste, die öffentlich im Internet bereitgestellt werden (zum Beispiel öffentlich erreichbare Webanwendungen des Auftraggebers), können hiervon ausgenommen sein; Zugriffe auf interne Systeme, die nicht öffentlich erreichbar sind, erfolgen ausschließlich über die VPN-Gateway-Systeme, sofern dies nicht anderweitig in der Anlage festgelegt ist.
...
Soweit in der Anlage ein Deploy-System „cus-util-prod-deploy-1“ aufgeführt ist, kann der Auftraggeber den Server nutzen, um von dort Ansible-Kommandos unter Verwendung des Playbook-Git-Repositorys auszuführen und damit die Infrastruktur zu verwalten.
...
Die Anlage ist integraler Bestandteil dieses Service-Level-Agreements. Sie dient der Abbildung der vom Auftraggeber durch den Auftragnehmer zu betreuenden Systeme sowie der für diese Systeme geltenden Parameter.

Der Vertragstext dieses SLA bildet die Grundlage für alle in der Anlage aufgeführten Systeme. Die Anlage konkretisiert für die dort bezeichneten Systeme die Anwendung der in diesem SLA vorgesehenen Leistungsarten und Parameter und kann diese – soweit in der Anlage ausdrücklich geregelt – ergänzen oder abweichend festlegen. Soweit die Anlage keine abweichende oder ergänzende Regelung trifft, gelten ausschließlich die in diesem SLA beschriebenen Regelungen.
...
- die je Zeitfenster gebuchten Notfallreaktionszeiten nach Ziffer 5.1.2, die einheitlich für alle Produktiv-Systeme im Sinne von Ziffer 5.1 gelten,
...
- die Kennzeichnung, ob das System als Produktiv-System für Notfallreaktionszeiten im Sinne von Ziffer 5.1 geführt wird.
...
Der Auftragnehmer betreibt und wartet die in der Anlage aufgeführten Systeme im vertraglich vereinbarten Umfang und nach Maßgabe dieses Service-Level-Agreements. Art und Umfang der laufenden Betriebs- und Wartungsleistungen ergeben sich insbesondere aus den technischen Grundlagen nach Ziffer 2; die Anlage konkretisiert diese Grundlagen für die dort aufgeführten Systeme und kann sie abweichend oder ergänzend regeln.
...
Der Auftragnehmer richtet, soweit technisch möglich, auf den in der Anlage bezeichneten Systemen den Debian-Paketmanager „apt“ mit dem Paket „unattended-upgrades“ so ein, dass stündlich auf verfügbare Sicherheitsupdates geprüft und diese automatisch installiert werden.
...
Ist bei der unverzüglichen Durchführung eines solchen Sicherheitsupdates mit einer Beeinträchtigung oder Nichtverfügbarkeit von Systemen zu rechnen, die in der Anlage als Produktiv-Systeme im Sinne von Ziffer 5.1 bezeichnet sind, informiert die jeweils ausführende Vertragspartei die jeweils andere Vertragspartei, soweit dies nach Lage des Einzelfalls machbar und sinnvoll ist, vorab über den in der Anlage bezeichneten allgemeinen Chat-Raum. Bleibt eine Rückmeldung innerhalb von fünf Minuten nach Absendung der Nachricht aus, ist die ausführende Vertragspartei gleichwohl berechtigt, das Sicherheitsupdate unmittelbar, auch außerhalb der Wartungszeiten, ohne vorherige Zustimmung oder Rückmeldung der jeweils anderen Vertragspartei durchzuführen.
...
Größere Versionssprünge und Änderungen mit potenziell wesentlichen Auswirkungen (insbesondere Kernel-Hauptversionen, Datenbank-Hauptversionen sowie vergleichbare Upgrades von Middleware-Komponenten, bei denen absehbar ist, dass sie die Lauffähigkeit der vom Auftraggeber auf den Systemen betriebenen Anwendungen beeinträchtigen können, etwa weil ein Upgrade der Datenbanksoftware zu einer vorübergehenden Nichtverfügbarkeit einer Website führen kann oder ein Neustart (zum Beispiel nach einem Kernel-Upgrade) erforderlich ist) bedürfen der vorherigen Abstimmung mit dem Auftraggeber und gelten, sofern nicht in der Anlage abweichend vereinbart, als gesondert zu vergütende Leistungen zum Standardsatz. Solche Maßnahmen werden vom Auftragnehmer nur nach ausdrücklicher Beauftragung oder aufgrund einer gesonderten Vereinbarung durchgeführt.
...
Verweigert der Auftraggeber Sicherheitsupdates für von ihm verwaltete Anwendungen oder Komponenten dauerhaft oder wiederholt oder betreibt er bewusst Versionen, für die vom Hersteller, Distributor oder Paketbetreiber keine Sicherheitsupdates mehr bereitgestellt werden, übernimmt der Auftragnehmer hierfür keine Verantwortung. Sicherheitsvorfälle, Ausfälle oder sonstige Beeinträchtigungen, die auf solche nicht oder nicht mehr gewarteten Komponenten zurückzuführen sind, gelten nicht als Verletzung von Pflichten aus diesem Service-Level-Agreement.
...
Der Auftragnehmer treibt Entstörungen mit der gebotenen Sorgfalt und nach pflichtgemäßem, fachlich begründetem Ermessen zügig voran und arbeitet, soweit organisatorisch und personell möglich, bis zur Behebung fortlaufend daran weiter. Gleichwohl ist der Auftragnehmer nicht verpflichtet, ununterbrochen an der Entstörung zu arbeiten; er kann die im Notfall zu erbringenden Leistungen in wirtschaftlich und organisatorisch angemessenen Arbeitsphasen mit dazwischenliegenden Ruhephasen erbringen und ist insbesondere nicht verpflichtet, länger als sechs aufeinanderfolgende Stunden ohne Unterbrechung an derselben Störung zu arbeiten. Nach einer ununterbrochenen Arbeitsphase von sechs Stunden steht dem Auftragnehmer eine Ruhepause von bis zu zwei Stunden zu.

Die zulässige Dauer einer ununterbrochenen Arbeitsphase beginnt mit dem Zeitpunkt, zu dem der Auftragnehmer die Arbeiten an der jeweiligen Störung tatsächlich aufnimmt, nicht mit dem Eingang der Notfallmeldung. Der Auftragnehmer ist darüber hinaus nicht verpflichtet, innerhalb eines Zeitraums von 24 Stunden ab Aufnahme der Arbeiten zur Entstörung eines Notfalls mehr als insgesamt zwölf Stunden Arbeitszeit im Rahmen der Notfallbearbeitung zu erbringen.

Der Auftraggeber verpflichtet sich, den Auftragnehmer im Vorfeld zu benachrichtigen, wenn durch anstehende Arbeiten an den Systemen Störungen oder Ausfallzeiten absehbar und notwendig sind. Der Auftragnehmer kann die von ihm eingesetzten Monitoring-Systeme nutzen, um Störungen zu erkennen und nach fachlichem Ermessen darauf zu reagieren; Monitoring-Alarmierungen ersetzen jedoch keine Notfallmeldung im Sinne dieser Ziffer. Garantierte Notfallreaktionszeiten werden ausschließlich durch eine Notfallmeldung gemäß Ziffer 5.1.1 ausgelöst.
...
Für jedes der nachfolgend aufgelisteten Zeitfenster kann der Auftraggeber eine maximale Notfallreaktionszeit aus den in den dem jeweiligen Zeitfenster zugeordneten nachfolgenden Tabellen aufgeführten Optionen buchen. Die je Zeitfenster gebuchte Notfallreaktionszeit gilt einheitlich für alle Produktiv-Systeme im Sinne von Ziffer 3.2. Für jedes gebuchte Zeitfenster fällt die Monatspauschale an, die in der dem jeweiligen Zeitfenster unmittelbar nachgeordneten Tabelle der gewählten Notfallreaktionszeit zugeordnet ist.
...
Kosten pro begonnener 60 Minuten Arbeitszeit zur Entstörung von Notfällen an Werktagen von 20:00 bis 10:00 Uhr: 125,00 Euro
...
Kosten pro begonnener 60 Minuten Arbeitszeit zur Entstörung von Notfällen an Wochenenden und gesetzlichen Feiertagen von 10:00 bis 20:00 Uhr: 140,00 Euro
...
Die Berechnung erfolgt in der nach Ziffer 1.2 beschriebenen Zeitzone.

Die Gesamtzeit des Kalendermonats ist die tatsächliche Anzahl von Minuten und Sekunden des Kalendermonats, in dem der Ausfall auftritt. Für jeden Kalendermonat wird die tatsächliche Anzahl von Stunden, Minuten und Sekunden zugrunde gelegt.
...
Aus der vorstehenden Berechnungsformel ergeben sich für die in diesem SLA vorgesehenen Verfügbarkeitsziele und die unterschiedlichen Monatslängen (einschließlich der verschiedenen Minutenzahlen infolge von Zeitumstellungen und Schaltjahren) die maximal zulässigen Ausfallzeiten, die in nachstehender Tabelle dargestellt sind.
...
- Zeiten, in denen das betroffene System im Rahmen der nach Ziffer 5.3 oder abweichend in der Anlage vereinbarten Wartungsfenster gewartet wird;
...
Beispiel: Beträgt der Betriebs- und Wartungspauschale zugrunde gelegte Wartungsaufwand pro System und Monat 30 Minuten und ist als Verfügbarkeitsziel 99,75 % mit einem Verfügbarkeitszuschlag von 100 Prozent vereinbart, sind für dieses System 60 Minuten pro Monat zum Standardsatz zu vergüten. Der Zuschlag richtet sich nach dem vereinbarten Verfügbarkeitsziel und beträgt:
...
Wartungsarbeiten im Sinne dieser Ziffer sind administrative Tätigkeiten des Auftragnehmers an den in der Anlage bezeichneten Systemen (insbesondere Installation von Updates, Konfigurationsänderungen, Neustarts oder vergleichbare Eingriffe). Im Rahmen solcher Wartungsarbeiten kann die Verfügbarkeit oder Leistungsfähigkeit des jeweiligen Systems oder der darauf betriebenen Dienste vorübergehend beeinträchtigt werden oder das System vorübergehend nicht zur Verfügung stehen. Wartungsarbeiten werden so geplant und durchgeführt, dass Umfang und Dauer unvermeidbarer Beeinträchtigungen der Verfügbarkeit auf das technisch notwendige Mindestmaß beschränkt werden.

Planbare Wartungsarbeiten werden, soweit technisch zumutbar, so durchgeführt, dass die vereinbarten Verfügbarkeitsziele voraussichtlich eingehalten werden.

Regelmäßige Prüfungen, Kontrollen oder sonstige Tätigkeiten, bei denen nach fachlicher Einschätzung des Auftragnehmers keine Beeinträchtigung zu erwarten ist, gelten nicht als Wartungsarbeiten im Sinne dieser Ziffer.

Wartungsarbeiten können innerhalb der nachfolgend geregelten Wartungszeiten sowie – soweit dies zur Aufrechterhaltung oder Wiederherstellung des Betriebs zwingend erforderlich ist oder auf ausdrücklichen Wunsch des Auftraggebers – ausnahmsweise auch außerhalb dieser Zeiten durchgeführt werden. 

Wartungsarbeiten, die innerhalb der vereinbarten Wartungszeiten durchgeführt werden, gelten nicht als Ausfälle im Sinne der Verfügbarkeitsziele nach Ziffer 5.2.
...
Wartungsarbeiten, bei denen nach fachlicher Einschätzung des Auftragnehmers eine Beeinträchtigung der Verfügbarkeit oder Leistungsfähigkeit des betroffenen Systems zu erwarten ist (insbesondere mögliche Ausfallzeiten), sind, sofern sie planbar sind, mindestens 48 Stunden im Voraus anzukündigen. Die Ankündigung erfolgt in Textform per E-Mail an die in der Anlage benannten technischen Ansprechpartner des Auftraggebers; ergänzend kann der Auftragnehmer die Ankündigung über weitere Kommunikationswege gemäß Ziffer 1.4 übermitteln. Individuelle Absprachen für Wartungsarbeiten außerhalb der vorstehenden Wartungszeiten sind nur mit vorherigem Einverständnis eines in der Anlage benannten technischen Ansprechpartners des Auftraggebers zulässig.


## 5.4 Katastrophenvorsorge und Desaster-Recovery

Der Auftragnehmer betreibt die Infrastruktur des Auftraggebers nach dem Grundsatz „Infrastructure as Code“, um einen weitgehend automatisierten Wiederaufbau und Wiederanlauf der in der Anlage bezeichneten Systeme zu ermöglichen.

Soweit für bestimmte Systeme in der Anlage eine Verfügbarkeit von mindestens 99,90 % vereinbart ist, erstellt und pflegt der Auftragnehmer einen schriftlichen Desaster-Recovery-Plan, der die Vorgehensweisen bei Teil- und Totalausfällen beschreibt und eine Wiederherstellung durch hinreichend geschultes Personal des Auftraggebers ermöglicht. Für neu hinzukommende Systeme wird der Plan innerhalb von zwei Wochen nach deren Aufnahme in die Anlage ergänzt. Die Regelungen zu Backups nach Ziffer 2.4.2 und zu Verfügbarkeitszielen nach Ziffer 5.2 bleiben unberührt.
...
Der Auftragnehmer gewährt administrativen Zugriff auf die Systeme und Dienste des Auftraggebers ausschließlich den in Ziffer 1.3 benannten Ansprechpartnern des Auftragnehmers und seinen festangestellten Mitarbeitern.

Der Auftragnehmer stellt sicher, dass alle Personen mit administrativem Zugriff auf die Systeme und Dienste des Auftraggebers zur Vertraulichkeit verpflichtet sind und nur im für die Erfüllung dieses Service-Level-Agreements erforderlichen Umfang Zugriff erhalten.

Die Weitergabe von administrativen Zugangsdaten an andere Personen oder Dritte ist unzulässig. Der Auftragnehmer ist berechtigt, einzelne administrative Zugriffsberechtigungen vorübergehend oder dauerhaft zu entziehen oder einzuschränken, soweit dies aus Sicherheitsgründen oder zur Einhaltung gesetzlicher oder vertraglicher Verpflichtungen erforderlich ist; der Auftraggeber wird hierüber unverzüglich informiert.


## 6.2 Verlust von Passwörtern und Zugängen

Der Auftraggeber hat den Auftragnehmer in allen Fällen von Verlust, Diebstahl, Offenlegung oder missbräuchlicher Nutzung von Zugangsdaten sowie bei geplanten oder fristlosen Kündigungen zugangsberechtigter Personen unverzüglich und zu jeder Tages- und Nachtzeit als Notfall im Sinne von Ziffer 5.1 über den Meldeweg nach Ziffer 5.1.1 zu informieren. Die Notfallmeldung ist zeitnah durch ein Issue in der Git-Hosting-Anwendung des Playbook-Git-Repositories zu dokumentieren.
...
Das Service-Level-Agreement tritt mit Unterzeichnung in Kraft und läuft auf unbestimmte Zeit.

Der Auftraggeber kann dieses Service-Level-Agreement einschließlich der Anlage jederzeit ohne Angabe von Gründen mit sofortiger Wirkung kündigen; die Kündigung erfolgt in Textform per E-Mail gemäß Ziffer 1.4.

Der Auftragnehmer kann dieses Service-Level-Agreement einschließlich der Anlage ohne Angabe von Gründen mit einer Frist von 60 Tagen kündigen; die Kündigung erfolgt in Textform per E-Mail gemäß Ziffer 1.4. Das Recht des Auftragnehmers zur fristlosen Kündigung aus wichtigem Grund bleibt unberührt.


## 7.2 Außerordentliche Kündigung aus wichtigem Grund

Der Auftragnehmer ist berechtigt, dieses Service-Level-Agreement aus wichtigem Grund ohne Einhaltung einer Kündigungsfrist zu kündigen. Die gesetzlichen Rechte des Auftraggebers zur außerordentlichen Kündigung aus wichtigem Grund bleiben unberührt.

Ein wichtiger Grund liegt vor, wenn dem Auftragnehmer unter Berücksichtigung aller Umstände des Einzelfalls und unter Abwägung der beiderseitigen Interessen die Fortsetzung dieses Service-Level-Agreements bis zum Ablauf der ordentlichen Kündigungsfrist oder bis zur sonstigen Beendigung nicht zugemutet werden kann.
...
- der Auftraggeber erforderliche Admin-Zugänge im Sinne von Ziffer 6.3 trotz Aufforderung per E-Mail an den in der Anlage benannten technischen Ansprechpartner nicht unverzüglich, spätestens jedoch innerhalb von 72 Stunden wiederherstellt, soweit dem Auftraggeber dies nicht aus Gründen höherer Gewalt oder vergleichbarer, von ihm nicht zu vertretender Umstände unmöglich ist,
...
3. Ausfälle, welche durch Wartungsarbeiten zu den vereinbarten Wartungszeiten verursacht wurden, sofern diese Arbeiten zur Erfüllung des Service Level Agreements notwendig sind und in anderer Form nicht oder nur durch unzumutbaren zusätzlichen Aufwand durchführbar wären.
...
6. Ausfälle, welche durch Fehler der auf den Systemen eingesetzten Software (zum Beispiel Bugs in Betriebssystemen, Datenbanken oder Anwendungen) verursacht werden, soweit der Auftragnehmer die ihm obliegenden Pflichten bei Auswahl, Installation, Konfiguration und Pflege dieser Software nicht verletzt hat; im Übrigen richtet sich die Haftung nach den vorstehenden Regelungen, insbesondere Ziffer 8.1 Absätze 3 bis 5.
7. Ausfälle, welche auf fahrlässiges Handeln der Mitarbeiter des Auftraggebers zurückzuführen sind.

Weitergehende Ansprüche gegen den Auftragnehmer, insbesondere auf Ersatz mittelbarer oder atypischer Folgeschäden (zum Beispiel Reputations- oder Vertrauensschäden), sind ausgeschlossen, soweit es sich nicht um Schäden handelt, die als direkte oder mittelbare, vertragstypische und vorhersehbare Folge einer Verletzung wesentlicher Vertragspflichten nach den vorstehenden Regelungen, insbesondere Ziffer 8.1 Absätze 3 bis 5, zu ersetzen sind.
...
1. Im Übrigen haftet der Auftragnehmer nur bei Nichtvorhandensein einer garantierten Beschaffenheit sowie für Vorsatz und grobe Fahrlässigkeit. Dies schließt auch seine gesetzlichen Vertreter, seine in diesem Service-Level-Agreement angegebenen Ansprechpartner sowie seine festangestellten Mitarbeiter ein.
...
3. Für leichte Fahrlässigkeit haftet der Auftragnehmer nur, sofern eine wesentliche Vertragspflicht verletzt wird, deren Erfüllung die ordnungsgemäße Durchführung dieses Service-Level-Agreements überhaupt erst ermöglicht und auf deren Einhaltung der Auftraggeber regelmäßig vertrauen darf (Kardinalspflicht). Wesentliche Vertragspflichten in diesem Sinne sind insbesondere die Pflichten, die in diesem Service-Level-Agreement geregelten Betriebs-, Wartungs- und Backupleistungen (einschließlich der Backups nach Ziffer 2.4.2 sowie der vereinbarten Service Levels nach Ziffer 5) im vereinbarten Umfang zu erbringen.
...
5. Bei einfach fahrlässig verursachtem Verlust von Daten haftet der Auftragnehmer – sofern er seine Pflichten zur Einrichtung und Durchführung der Backups nach Ziffer 2.4.2 ordnungsgemäß erfüllt hat – abweichend von Ziffer 4 nur für die Kosten, die für die Wiederherstellung der Daten aus den nach Ziffer 2.4.2 vorgesehenen Backups erforderlich gewesen wären. Soweit der Datenverlust darauf beruht, dass der Auftragnehmer diese Pflichten verletzt hat, richtet sich die Haftung nach den vorstehenden Regelungen, insbesondere Ziffer 8.1 Absätze 3 und 4.
...
Der Auftragnehmer hält für die Laufzeit dieses Service‑Level‑Agreements eine IT‑Haftpflichtversicherung mit Deckungssummen von 3.000.000 (drei Millionen) Euro für Vermögensschäden sowie 3.000.000 (drei Millionen) Euro für Personen‑ und Sachschäden vor.

Für Vertragsstrafen wegen der Verletzung von Geheimhaltungs‑, Vertraulichkeits‑ oder Datenschutzvereinbarungen bzw. ‑erklärungen gilt eine Entschädigungsgrenze von 300.000 (dreihunderdtausend) Euro; diese Entschädigungsgrenze ist Teil der Versicherungssumme.

Der Auftragnehmer informiert den Auftraggeber unverzüglich, wenn die IT-Haftpflichtversicherung gekündigt, ausgesetzt oder in für den Auftraggeber wesentlicher Weise eingeschränkt wird.
...
Das Service-Level-Agreement einschließlich der Anlage bildet die abschließende Regelung über den Leistungsumfang des Auftragnehmers nach diesem Vertrag. Weitere Vereinbarungen über Leistungen des Auftragnehmers gelten nur, soweit sie in der Anlage ausdrücklich bezeichnet sind.

Änderungen und Ergänzungen dieses Service-Level-Agreements einschließlich der Anlage bedürfen der Zustimmung beider Vertragsparteien und der Textform per E-Mail gemäß Ziffer 1.4. Dies gilt auch für eine Änderung dieser Ziffer. Für inhaltliche Änderungen der Anlage tritt an die Stelle der Textform die in Ziffer 3.1 beschriebene Git-Mechanik.


## 9.2 Rechtswahl und Gerichtsstand

Für dieses Service-Level-Agreement einschließlich Anlage gilt das Recht der Bundesrepublik Deutschland unter Ausschluss des UN-Kaufrechts (CISG).

Ausschließlicher Gerichtsstand für alle Streitigkeiten aus oder im Zusammenhang mit diesem Service-Level-Agreement einschließlich Anlage ist – soweit gesetzlich zulässig – der Sitz des Auftragnehmers in Berlin.
...
Sofern einzelne Bestimmungen dieses Service-Level-Agreements oder der Anlage ganz oder teilweise nicht rechtswirksam oder nicht durchführbar sind oder werden, bleibt die Wirksamkeit der übrigen Bestimmungen dieses Service-Level-Agreements und der Anlage unberührt.
...
Der Auftraggeber bestätigt, dass ihm die technischen und vertraglichen Regelungen dieses Service-Level-Agreements einschließlich der Anlage erläutert wurden und er deren Inhalt verstanden hat.
...
_________________________								_________________________
Unterschrift Max Mustermann								Unterschrift Peter Thurner
Geschäftsführer Example GmbH							Geschäftsführer Blunix GmbH
E-Mail: m.mustermann@example.com						E-Mail: p.thurner@blunix.com
